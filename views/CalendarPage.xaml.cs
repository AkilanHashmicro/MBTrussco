...
namespace SalesApp.views
{
    ...
    public partial class CalendarPage : ContentPage
    {
        ...
        private void Calendar_OnCalendarTapped(object sender, CalendarTappedEventArgs args)
        {
            ...
            var dateselected = calendar.SelectedDate.Date.ToString("yyyy-MM-dd");
             App.calselecteddate = dateselected;              List<all_events> selectedCalDate = calresult.Where((cal) =>             {
                ...
                //} 
                //return cal.ContainsLoop(cal.meeting_days, dateselected);              } ).ToList<all_events>();              SelectDate.Text = calendar.SelectedDate.Date.ToString("dd MMM");             CalendarListView.ItemsSource = selectedCalDate;
